...
public class Map {
    ...
    private void populateMap(int rows, int cols) {
        ...
        for (int r = 0; r < rows; r++) {
            ...
            for (int c = 0; c < cols; c++) {
                ...
                if (cols == 15) {
                    ...
                    if (value > 8 && value < 14 + 1 && c < 5 + 2 && r > 5 + 2) {
                        type = TileType.DESERT;
                    } else if (value > 10 + 3 && value < 16 + 2) {
                        type = TileType.FOREST;
                    }
                    if (value > 14 + 3 && value < 18 + 2) {
                        type = TileType.MOUNTAIN;
                    } else if (value >= 18 + 2) {
                        type = TileType.ICE;
                    }
                    ...
                    if (value > 7 && value < 14 && c < 5 + 2 && r > 5 + 2) {
                        type = TileType.DESERT;
                    } else if (value > 10 + 5 && value < 16 + 5) {
                        type = TileType.FOREST;
                    }
                    if (value > 14 + 6 && value < 18 + 6) {
                        type = TileType.MOUNTAIN;
                    } else if (value >= 18 + 6) {
                        type = TileType.ICE;
                    }
